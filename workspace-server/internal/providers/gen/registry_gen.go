...
const Fingerprint = "2c3a5860657f89eb"
...
var Runtimes = map[string][]GenRuntimeRef{
	"claude-code": {
		...
		{Name: "anthropic-api", Models: []string{"claude-fable-5", "claude-sonnet-4-6", "claude-opus-4-7", "claude-opus-4-8", "claude-haiku-4-5", "claude-sonnet-4-5", "anthropic:claude-fable-5", "anthropic:claude-sonnet-4-6", "anthropic:claude-opus-4-7", "anthropic:claude-opus-4-8", "anthropic:claude-haiku-4-5", "anthropic:claude-sonnet-4-5"}},
		...
		{Name: "platform", Models: []string{"anthropic/claude-fable-5", "anthropic/claude-opus-4-7", "anthropic/claude-opus-4-8", "anthropic/claude-sonnet-4-6", "moonshot/kimi-k2.6", "moonshot/kimi-k2.5", "minimax/MiniMax-M2.7", "minimax/MiniMax-M2.7-highspeed", "minimax/MiniMax-M3"}},
