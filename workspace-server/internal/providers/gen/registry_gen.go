...
//
// Source of truth: go.moleculesai.app/sdk/gen/go/llmregistry (schema_version 1).
...
var Runtimes = map[string][]GenRuntimeRef{
	...
	"openclaw": {
		...
		{Name: "custom", Models: []string{}},
		{Name: "byok-openai", Models: []string{}},
		{Name: "byok-minimax", Models: []string{"minimax:MiniMax-M2.7", "minimax:MiniMax-M2.7-highspeed"}},
