#!/usr/bin/env bash
# reload-staging-controlplane.sh — project a STAGING tenant image into Railway
# and recreate the staging control plane so fresh provisions read it.
#
...
#   reload-staging-controlplane.sh --image ... --dry-run
#
# Required env:
