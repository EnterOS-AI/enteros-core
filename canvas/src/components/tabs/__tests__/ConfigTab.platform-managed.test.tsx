      ...
      templates: [
        {
          ...
          registry_models: [
            { id: "byok-sonnet", provider: "anthropic", required_env: ["ANTHROPIC_API_KEY", "MOLECULE_LLM_USAGE_TOKEN"] },
            { id: "platform-sonnet", provider: "platform", required_env: ["MOLECULE_LLM_USAGE_TOKEN"] },
          ],
        },
      ],
    });
      ...
      templates: [
        {
          ...
          registry_models: [
            { id: "byok-sonnet", provider: "anthropic" },
          ],
        },
      ],
    });
